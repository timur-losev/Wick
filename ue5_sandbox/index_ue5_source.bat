...
curl -s -X POST http://127.0.0.1:8080/ ^
  ...
  -d "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"index.start\",\"params\":{\"repo_root\":\"%UE5_SOURCE:\=/%\",\"resume\":false,\"flush_every_chunks\":5000,\"ingest_batch_size\":32,\"target_tokens\":400,\"max_chunks\":0,\"include_extensions\":[\".h\",\".hpp\",\".cpp\",\".inl\",\".inc\"],\"exclude_dirs\":[\"ThirdParty\",\"Intermediate\",\"DerivedDataCache\",\"Binaries\"],\"enrich_regex\":true,\"enrich_llm\":false}}"
